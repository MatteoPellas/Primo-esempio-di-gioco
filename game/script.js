...
const enemiesLeft = new Image();
enemiesLeft.src = "walk left (1).png"
const enemiesRight = new Image();
enemiesRight.src = "walk (1).png"
...
class Enemy{
    ...
    draw(){
        drawImage(enemiesRight, this.x, this.y, this.width, this.height);

        //ctx.drawImage(enemiesRight, 0, 0, this.width, this.height, this.x, this.y, this.width/4, this.height/4)
    }
}
